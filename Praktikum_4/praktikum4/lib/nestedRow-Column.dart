...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Sandal',
      home: buildHomePage('Yohanes - 2211102038'),
    );
  }
  ...
  Widget buildHomePage(String title) {
    ...
    const subTitle = Text(
      'Sandal adalah salah satu model alas kaki yang terbuka pada bagian jari kaki atau tumit pemakainya.',
    ...
    final mainImage = Image.asset('Gambar/download.jpeg', fit: BoxFit.cover);
