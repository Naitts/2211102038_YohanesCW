      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 20), // Jarak antara teks dan tombol submit
            ElevatedButton(
              onPressed: () {
                print('ini done');
              },
            ...
            const SizedBox(height: 10), // Jarak antara tombol submit dan menu
            TextButton(
              onPressed: () {
                print('sukses');
              },
            ...
            const SizedBox(height: 10), // Jarak antara tombol menu dan dropdown
